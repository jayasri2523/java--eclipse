<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="ai.jobiak.model.*"%>
<!DOCTYPE html>
<html>
<head>
...
<%!
private ArrayList<Products> getProductIds()
{
 ...
 while(rs.next())
 {
 Products p=new Products(rs.getString(1),rs.getString(2),rs.getDouble(3));
 productList.add(p);
 } 
 }catch (Exception e) { 
   e.printStackTrace(); 
...
%>
 <hr/>
<% 
 ArrayList<Products> itemsList=null;
  ...
  for(int i=0;i<itemsList.size();i++){
   ...
   ArrayList<Products> selectedItemsList=null;
  ...
  selectedItemsList=(ArrayList<Products>)shoppingCart.getAttribute("items");
 ...
 for(Products p:selectedItemsList){
...
<% 
  ...
  out.println("<h3>Total Price:"+TotalCost);
