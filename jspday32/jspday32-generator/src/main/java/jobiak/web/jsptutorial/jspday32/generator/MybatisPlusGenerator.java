package jobiak.web.jsptutorial.jspday32.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "jobiak.web.jsptutorial.jspday32";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/jspday32-model"),
        mapper("/jspday32-dao"),
        mapperxml("/jspday32-web"),
        service("/jspday32-service"),
        web("/jspday32-web"),
        ;
